...
[![Deploy to GitHub Pages](https://github.com/FahadAbdulQayyum/Physical-AI-Humanoid-Robotics-Textbook/actions/workflows/deploy.yml/badge.svg)](https://github.com/FahadAbdulQayyum/Physical-AI-Humanoid-Robotics-Textbook/actions/workflows/deploy.yml)
[![Build Validation](https://github.com/FahadAbdulQayyum/Physical-AI-Humanoid-Robotics-Textbook/actions/workflows/build-validation.yml/badge.svg)](https://github.com/FahadAbdulQayyum/Physical-AI-Humanoid-Robotics-Textbook/actions/workflows/build-validation.yml)
...
This project follows **Spec-Driven Development (SDD)** using [Spec-Kit Plus](https://github.com/FahadAbdulQayyum/spec-kit-plus):
...
- Following [Spec-Kit Plus](https://github.com/FahadAbdulQayyum/spec-kit-plus) methodology
- Inspired by industry best practices in robotics education

## Support

- **Issues**: [GitHub Issues](https://github.com/FahadAbdulQayyum/Physical-AI-Humanoid-Robotics-Textbook/issues)
- **Discussions**: [GitHub Discussions](https://github.com/FahadAbdulQayyum/Physical-AI-Humanoid-Robotics-Textbook/discussions)
